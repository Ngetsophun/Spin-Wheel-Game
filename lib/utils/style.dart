...
class TextStyles {
  ...
  static const bodyReg30 = TextStyle(fontFamily: 'Gluten', fontSize: 30, color: lightOrange);
  static const bodyReg40 = TextStyle(fontFamily: 'Gluten', fontSize: 40, color: lightOrange);
}
